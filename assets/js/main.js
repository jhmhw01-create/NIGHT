...
if (!reduceMotion) {
  ...
  document.querySelectorAll('.hero-title, .section-title, .member-title, .contents-hero h1, .travel-hero h1, .behind-hero h1, .medley-hero h1').forEach((title) => titleObserver.observe(title));
